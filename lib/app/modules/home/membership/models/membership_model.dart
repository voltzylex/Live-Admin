...
class MembershipModel extends Equatable {
    ...
    factory MembershipModel.fromJson(Map<String, dynamic> json){ 
        return MembershipModel(
            ...
            myPlans: json["my_plans"] == null ? [] : List<MyPlan>.from(json["my_plans"]!.map((x) => MyPlan.fromJson(x))),
...
class MyPlan extends Equatable {
    ...
    @override
    List<Object?> get props => [
    id, userId, planId, name, price, startDate, endDate, status, createdAt, updatedAt, user, ];
}
